...
layui.use(['form', 'jquery', "layer"], function () {
    ...
    if (window.sessionStorage.getItem('userFace') && $(".userAvatar").length > 0) {
        ...
        $("#userFace").attr("src", "../../images/userface1.jpg");
    }
    ...
    function showNotice() {
        layer.open({
                ...
                moveType: 1,
                content: '欢迎来到一本好书<br>' +
                'main和书架:不知道弄点啥，放几张图片吧<br>' +
                '修改manager密码：暂不对外进行开放',
...
//锁屏
    function lockPage() {
        layer.open({
            ...
            '<div class="admin-header-lock-img"><img src="static/index/images/link.jpg" class="userAvatar"/></div>' +
            '<div class="admin-header-lock-name" id="lockUserName">勇哥</div>' +
            '<div class="input_btn">' +
